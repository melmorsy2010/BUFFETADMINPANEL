...
class Colddrinks2 extends StatefulWidget {


  const Colddrinks2({Key? key}) : super(key: key);

  @override
  _Colddrinks2State createState() => _Colddrinks2State();
}

class _Colddrinks2State extends State<Colddrinks2> {
  ...
  Future<void> _updateData() async {
    ...
    if (ScaffoldMessenger.of(context).mounted) {
      ...
      final String path = 'juice70.json';
      print("hh");

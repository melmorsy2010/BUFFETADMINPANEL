...
import 'package:retailtribeadmin/home.dart';



class JsonData3 extends StatefulWidget {


  const JsonData3({Key? key}) : super(key: key);

  @override
  _JsonData3State createState() => _JsonData3State();
}

class _JsonData3State extends State<JsonData3> {
  ...
  void initState() {
    super.initState();
    _itemImageUrlController = TextEditingController(text: 'https://img.freepik.com/premium-vector/coffee-cup-symbol-vector-icon-hot-drink-icon-cup-coffee-with-steam_538002-568.jpg?w=2000');
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: () {
                // do something when the user presses the icon
              },
            ),
          ],
        ),

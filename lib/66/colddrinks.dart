...
class Colddrinks4 extends StatefulWidget {


  const Colddrinks4({Key? key}) : super(key: key);

  @override
  _Colddrinks2State createState() => _Colddrinks2State();
}

class _Colddrinks2State extends State<Colddrinks4> {
  final imageController = TextEditingController(text: 'https://example.com/default-image.png');
  ...
  void initState() {
    super.initState();
    _itemImageUrlController = TextEditingController(text: 'https://i.pinimg.com/originals/18/0a/81/180a81a4c9772dcc5b8e4849ce44b6ea.jpg');
  ...
  Future<void> _updateData() async {
    ...
    if (ScaffoldMessenger.of(context).mounted) {
      ...
      final String path = 'juice66.json';
      print("hh");
